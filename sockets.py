...
myWorld = World()        
# Reference : https://github.com/abramhindle/WebSocketsExamples/blob/master/chat.py#L40
clients = list()
...
def read_ws(ws,client):
    ...
    # Reference : https://github.com/abramhindle/WebSocketsExamples/blob/master/chat.py#L65
    try:
        while True:
            msg = ws.receive()
            print("WS RECV: %s" % msg)
